...
{
    public class OceanicAirlinesShippingHttpRequester : IShippingHttpRequester
    {
        ...
        public async Task<Costs> OutboundShippingRequest(List<Parcel> parcelList, int startCityId, int destinationCityId)
        {
            ...
            var response = client.PostAsync("https://wa-oa-dk2.azurewebsites.net/ShippingIntegration", byteContent);
